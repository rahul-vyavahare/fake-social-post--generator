...
export const Instagram = () => {
    ...
    return (<>
        <div className="insta-pad-container" style={{ display: "grid", marginBottom: 50, width: '100%', justifyContent:"center" }}>
            <h1 className="insta-head"> Instagram Post Generator</h1>
            <div className="insta-container" style={{ }}>
                <div className="insta-post-outer" style={{}}>
                ...
                <div className="insta-input-container" style={{}}>
                    <h3>Post Data</h3>
                    <div className="input-image-container" style={{  }}>
                        <div className="insta-input-image-div" style={{cursor: profile ? "not-allowed" : "pointer"}}>
                            <div className="insta-click-div" style={{ width: "",  pointerEvents: profile ? "none":""}}>
                        ...
                        <div className="insta-input-image-div" style={{  cursor: img ? "not-allowed":"pointer" }}>
                            <div className="insta-click-div" style={{ width: "", cursor: img ? "not-allowed" : "pointer", pointerEvents: img ? "none" : "" }}>
                    ...
                    <div className="insta-input-username" style={{  }}><TextField label="Username" id="username" name="username" value={username} onChange={(e) => e.target.value.length <= 30 ? setUsername(e.target.value) : setUsername(e.target.value.substring(0, 30))} sx={{ width: "inherit", backgroundColor: "#FFFFFF", height:55 }} fullWidth autoComplete="off"
                    InputProps={{
                ...
                /></div>
                    <div className="insta-input-feild-container" style={{ }}>
                        <div className="insta-input-feild" style={{}}><TextField label="Description" id="description" name="description" value={description} onChange={(e) => e.target.value.length <= 40 ? setDescription(e.target.value) : setDescription(e.target.value.substring(0, 40))} sx={{ width: "inherit !important", backgroundColor: "#FFFFFF", height: 55, minWidth: 200 }}  fullWidth autoComplete="off" /> </div>
                        <div className="insta-input-feild insta-date" style={{}}> {/*<TextField label="Post Date" id="tweet-date" name="date" sx={{ width: "inherit !important", backgroundColor: "#FFFFFF", height: 55, minWidth:200 }} type="datetime-local" value={cdate} fullWidth InputLabelProps={{
                    ...
                    <div className="insta-post-text"style={{
                        }}><TextField
                    id="tweet-text"
                ...
                /></div>
                    ...
                    <div className="insta-stats-container" style={{  }}>
                        <div className="insta-stats-feild" style={{}}><Box sx={{ width: "inherit" }}>
                        ...
                        <div className="insta-stats-feild" style={{}}><TextField label="Like Count" id="like" name="like" value={like} onChange={handleChange} sx={{ width: "inherit", backgroundColor: "#FFFFFF", height: 55 }} type="number" autoComplete="off" /></div>
                        <div className="insta-stats-feild" style={{}}><TextField label="Comment Count" id="comment" name="comment" value={comment} onChange={handleChange} sx={{ width: "inherit", backgroundColor: "#FFFFFF", height: 55 }} type="number" autoComplete="off" /></div>
                </div>
                    <div style={{ color: "#26274b", fontSize: 17, display: "grid", gap: 15,paddingLeft:"1%" }}>
            ...
            <div className="insta-comment-container-outer" style={{ display: "grid", gap: 30, marginTop:20 }}>
                <div style={{}}>
                   <h3> Comments</h3>
                </div>
                <div className="insta-comment-container" style={{  }}>
                    <div className="insta-comment-name" style={{}}>   <TextField label="First Comment Username" id="first-username" name="first-username" value={firstUser} onChange={(e) => setFirstuser(e.target.value)} sx={{ width: "inherit", backgroundColor: "#FFFFFF", height: 55 }}  autoComplete="off" /></div>
                    <div className="insta-comment-text" style={{}}>   <TextField label="First Comment Text" id="first-text" name="first-text" value={firstUserText} onChange={(e) => e.target.value.length <= 120 ? setFirstusertext(e.target.value) : setFirstusertext(e.target.value.substring(0, 120))} sx={{ width: "inherit", backgroundColor: "#FFFFFF", height: 55 }}  autoComplete="off" /></div>

                </div>
                <div className="insta-comment-container" style={{  }}>
                    <div className="insta-comment-name" style={{}}>  <TextField label="Second Comment Username" id="second-username" name="second-username" value={secondUser} onChange={(e) => setSeconduser(e.target.value)} sx={{ width: "inherit", backgroundColor: "#FFFFFF", height: 55 }}  autoComplete="off" /></div>
                    <div className="insta-comment-text" style={{}}> <TextField label="Second Comment Text" id="second-text" name="second-text" value={secondUserText} onChange={(e) => e.target.value.length <= 120 ? setSecondusertext(e.target.value) : setSecondusertext(e.target.value.substring(0, 120))} sx={{ width: "inherit", backgroundColor: "#FFFFFF", height: 55 }}  autoComplete="off" /></div>
