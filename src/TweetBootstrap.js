...
const TweetBootstrap = () => {
    ...
    return (<div className="container-fluid m-md-3 m-sm-0 ">
       {/* <h1 className="text-center text-lg-start" >Tweet</h1>*/}
        <div className="row justify-content-center">
            <div className="col col-md-10 col-lg-8 col-xl-8">
                <h1 className="text-center text-lg-start" >Tweet Generator</h1>

                <div className="row justify-content-center">
               {/* <div className="col-8" style={{ width: 600, border: "1px solid #e1e1ef", backgroundColor: "white", minHeight:250 }}>*/}
                ...
                <div className="row d-md-block d-lg-flex mt-3 ">
                    <div className="col-12 col-md-12  col-lg-auto col-xl-auto col-xxl-auto my-md-3 my-3 ">
                        <div className="input-image-div-1" style={{ width: "inherit", minWidth:0 }}>
                            <div className="col" style={{ minWidth: 133, cursor: profile ? "not-allowed" : "pointer" }}>
                            ...
                            <div className="col-2 " style={{ display: "block", zIndex: 100, minWidth: 50 }}>{profile ? <><img src={profile} alt="f" style={{ width: 32, height: 32, borderRadius: 8, objectFit: "cover", zIndex: 100, position: "absolute", marginTop: 10 }} /> <i className="fa fa-times" aria-hidden="true" style={{ borderRadius: "50%", backgroundColor: "#DDDDDD", fontSize: 13, color: "black", zIndex: 110, right: "-32px", position: "relative" }} onClick={() => setProfile(null)} /></> : null}</div>
                            <input type="file" accept="image/*" id="profileI" style={{ display: "none" }} onChange={handleAvatarUpload} />
                        </div>
                </div>
                    <div className="col-12 col-md-12 col-lg col-xl col-xxl my-md-3 my-3 ">
                        <div className="input-image-div-2" style={{ width: "inherit", minWidth: 0 }}>
                            <div className="col" style={{ minWidth: 133,cursor: img.length === 4 ? "not-allowed" : "pointer" }}>
                            ...
                            <div className="col-6 pe-3 me-4" style={{ display: "flex", zIndex: 100, gap: 45, justifyContent: "end", transition: "0.2s" }}>
                ...
                <div className="row d-md-block d-lg-flex ">
                    <div className="col-md-12 col-lg col-xl col-xxl my-md-3 my-3 ">
                        <TextField label="Name" id="name" name="name" value={name} onChange={(e) => { e.preventDefault(); setName(e.target.value) }} sx={{ width: "inherit", backgroundColor: "#FFFFFF", minWidth: 200 }} fullWidth autoComplete="off" />
                    </div>
                    <div className="col-md-12 col-lg col-xl col-xxl my-md-3 my-3 ">
                        <TextField label="Username" id="username" name="username" value={username} onChange={(e) => { e.preventDefault(); setUsername(e.target.value) }} sx={{ width: "inherit", backgroundColor: "#FFFFFF", minWidth: 200 }} fullWidth autoComplete="off"
                            InputProps={{
                ...
                <div className="row d-md-block d-lg-flex my-3">
                    <div className="col-md-12 col-lg col-xl col-xxl ">
                        <TextField
                            id="tweet-text"
                            label="Tweet text"
                            type="text"
                ...
                <div className="row d-md-block d-lg-flex mb-sm-3 my-md-3 mb-xl-3">
                    <div className="col-md-12 col-lg col-xl col-xxl my-md-3 my-3 ">
                        <TextField label="Reply Count" id="reply" name="reply" value={reply} onChange={handleChange} sx={{ width: "inherit", backgroundColor: "#FFFFFF", minWidth: 200 }} fullWidth type="number" autoComplete="off" />
                </div>
                    <div className="col-md-12 col-lg col-xl col-xxl my-md-3 my-3 ">
                        <TextField label="Retweet Count" id="retweet" name="retweet" value={retweet} onChange={handleChange} sx={{ width: "inherit", backgroundColor: "#FFFFFF", minWidth: 200 }} fullWidth type="number" autoComplete="off" />
                </div>
                    <div className="col-md-12 col-lg col-xl col-xxl my-md-3 my-3 ">
                        <TextField label="Like Count" id="tweet-like" name="like" value={like} onChange={handleChange} sx={{ width: "inherit", backgroundColor: "#FFFFFF", minWidth: 200 }} fullWidth type="number" autoComplete="off" />
                </div>
            </div>
                <div className="row d-flex justify-content-center">
                    <Button variant="contained" disableRipple sx={{ textTransform: "none", width: 150 }} onClick={handleDebounce(downloadTweet, 200)}><i className="fa fa-download" aria-hidden="true" style={{ fontSize: 10, marginRight: 8 }} />Export Tweet</Button>
            </div>
            </div>
        </div>
